    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contactoCorreo', models.EmailField(max_length=150, verbose_name='correo de contacto')),
                ('contactoInstagram', models.CharField(blank=True, max_length=150, null=True, verbose_name='contacto en instagram')),
                ('contactoSitioWeb', models.TextField(blank=True, max_length=150, null=True, verbose_name='sitio web de contacto')),
                ('profilePic', models.ImageField(blank=True, default=Influencer.models.get_default_profile_image_filepath, max_length=255, null=True, upload_to=Influencer.models.get_profile_image_filepath)),
                ('likeTotales', models.IntegerField(default=0)),
                ('bio', models.TextField(verbose_name='pequeña descripción sobre ti')),
